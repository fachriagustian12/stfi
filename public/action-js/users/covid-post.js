          ...
          $.each(data, function(key, value) {
            ...
            content += `<div class="post single">
                					...
                					<ul class="post_details clearfix">
                						<li class="detail category"><a href="covid" title="`+value.satuan_name+`">COVID-19</a></li>
                						<li class="detail date">`+value.create_date+`</li>
                						<li class="detail author">oleh <a href="#" title="">`+value.create_by+`</a></li>
                						<li class="detail views">6 254 Views</li>
                						<li class="detail comments"><a href="#" class="scroll_to_comments" title="6 Comments">6 Comments</a></li>
                					</ul>
